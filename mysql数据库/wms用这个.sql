...
CREATE TABLE `w_category`  (
  ...
  `desc` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
...
CREATE TABLE `w_company`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `name`(`name`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '公司管理' ROW_FORMAT = Compact;
...
CREATE TABLE `w_customer`  (
  ...
  `sn` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `name` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '客户' ROW_FORMAT = Compact;
...
CREATE TABLE `w_goods`  (
  ...
  `product_no` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '产品编码',
  `goods_name` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `brand` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '品牌',
  `goods_spec` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `goods_weight` decimal(10, 3) UNSIGNED NOT NULL DEFAULT 0.000,
  `market_price` decimal(10, 2) UNSIGNED NOT NULL DEFAULT 0.00,
  `goods_price` decimal(10, 2) UNSIGNED NOT NULL DEFAULT 0.00,
  `add_time` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `unit` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '申报单位',
  `goods_sn_cus` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '海关备案号',
  `goods_sn_ciq` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商检备案号',
  ...
  `code_ts` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `g_weight` decimal(18, 5) NOT NULL DEFAULT 0.00000,
  `r_weight` decimal(18, 5) NOT NULL DEFAULT 0.00000,
  `for_orgin` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '原产国',
  `qty1` decimal(18, 5) NOT NULL DEFAULT 0.00000 COMMENT '法定数量',
  `unit1` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '法定单位',
  `qty2` decimal(18, 5) NOT NULL DEFAULT 0.00000 COMMENT '法定第二数量',
  `unit2` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '法定第二单位',
  `qty1_ratio` decimal(10, 2) UNSIGNED NULL DEFAULT 1.00 COMMENT '第一法定单位对应申报单位的换算系数',
  `qty2_ratio` decimal(10, 2) UNSIGNED NULL DEFAULT 1.00 COMMENT '第二法定单位对应申报单位的换算系数',
...
CREATE TABLE `w_location`  (
  ...
  `add_time` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '库位管理' ROW_FORMAT = Compact;
...
CREATE TABLE `w_menu`  (
  `id` mediumint(9) UNSIGNED NOT NULL AUTO_INCREMENT,
  `pid` mediumint(9) UNSIGNED NULL DEFAULT 0,
...
INSERT INTO `w_menu` VALUES (5, 4, '采购信息', NULL, 1, 'Instorage', 'index', 0, 5);
...
INSERT INTO `w_menu` VALUES (15, 8, '物品信息', NULL, 1, 'Product', 'index', 0, NULL);
...
CREATE TABLE `w_order`  (
  `id` mediumint(9) UNSIGNED NOT NULL AUTO_INCREMENT,
  `sn` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `car_no` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ban_no` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `detailed_no` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '载货清单号',
  `author` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `supplier` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `state` tinyint(1) UNSIGNED NULL DEFAULT NULL COMMENT '1',
  `type` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `res` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `desc` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
...
INSERT INTO `w_order` VALUES (5, 'SN2022102902145635035', '20', '635116', '51416545', '布尔', '苏州牧冬光电有限公司', 1, '采购入库', NULL, '测试入库', 1667024145);
INSERT INTO `w_order` VALUES (6, 'SN2022102902301568697', '20', '3519411', '1594981', '布尔', '苏州牧冬光电有限公司', 2, '采购出库', NULL, '测试出库', 1667025053);
INSERT INTO `w_order` VALUES (7, 'SN2022102902460229061', '20', '', '', 'dashen', '默认', 2, '采购出库', NULL, '我来出库了', 1667026023);
...
CREATE TABLE `w_order_good`  (
  ...
  `batch_no` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '导入批号',
  `referer` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '订单来源',
  `identify_no` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '身份证',
  `author` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '订单作者',
  `waybillno` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '物流编号',
  `delivery` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '第三方物流' COMMENT '送货方式',
  `receiver_name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '收件人',
  `receiver_phone` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '收件人电话',
  `receiver_province` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '收件省份',
  `receiver_city` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '收件城市',
  `receiver_district` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '收件县区',
  `receiver_address` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '收件地址',
  `sender_name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '发件人',
  `sender_phone` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '发件电话',
  `sender_address` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '发件地址',
  ...
  `shipping_fee` decimal(4, 2) UNSIGNED NULL DEFAULT 0.00 COMMENT '运费',
  `desc` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `add_time` int(11) UNSIGNED NOT NULL,
...
CREATE TABLE `w_order_goods`  (
  ...
  `goods_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '品名',
  `brand` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '品牌',
  `goods_spec` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '规格',
  `currency` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '币值',
  `product_no` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '产品编码',
  ...
  `unit` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '申报计量单位 3位代码',
  `unit2` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '法定第二单位',
  `g_weight` decimal(18, 5) NULL DEFAULT NULL COMMENT '毛重',
  `r_weight` decimal(18, 5) NULL DEFAULT NULL COMMENT '净重',
  `qty1` decimal(18, 5) NULL DEFAULT 0.00000 COMMENT '法定数量',
  `unit1` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '法定单位',
  `qty2` decimal(18, 5) NULL DEFAULT 0.00000 COMMENT '法定第二数量',
  PRIMARY KEY (`rec_id`) USING BTREE,
...
CREATE TABLE `w_order_info`  (
  ...
  `o_id` mediumint(9) UNSIGNED NULL DEFAULT NULL COMMENT '关联id',
  `ent_id` int(11) NULL DEFAULT 0 COMMENT '所属企业ID',
  `batch_no` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '导入批次号',
  `order_sn` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '电商内部订单号',
  `referer` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '订单来源',
  `waybillno` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '物流单号',
  `product_no` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '产品编码(必填)',
  `identify_no` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '身份证号码',
  `receiver_name` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '收件人姓名',
  `receiver_phone` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '收件人电话',
  `receiver_province` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '收件人省份',
  `receiver_city` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '收件人市',
  `receiver_district` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '收件人区县',
  `receiver_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '收件人地址',
  `sender_name` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '发件人姓名',
  `sender_phone` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '发件人电话',
  `sender_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '发件人地址',
  `g_weight` decimal(18, 5) NULL DEFAULT NULL COMMENT '毛重',
  `r_weight` decimal(18, 5) NULL DEFAULT NULL COMMENT '净重',
  `goods_number` smallint(5) UNSIGNED NULL DEFAULT 1,
  `goods_amount` decimal(10, 2) NULL DEFAULT 0.00,
  `currency` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '币值',
  `shipping_fee` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '运费',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '订单备注',
  `is_print` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '是否打印：0：未打印 1：已打印',
  `pick_status` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '拣货状态0：未拣货 1：拣货',
  `tally_status` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '理货状态0：未理货 1：挂起 2：理货完成',
  `out_status` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '出库状态0：未出库1：已出库',
  `add_time` int(11) NOT NULL,
  PRIMARY KEY (`order_id`) USING BTREE,
  INDEX `order_sn`(`order_sn`) USING BTREE,
  INDEX `waybillno`(`waybillno`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '发货' ROW_FORMAT = Compact;
...
CREATE TABLE `w_order_infow`  (
  ...
  `add_time` int(11) NOT NULL,
  PRIMARY KEY (`order_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '发货' ROW_FORMAT = Compact;
...
CREATE TABLE `w_order_list`  (
  `id` mediumint(9) UNSIGNED NOT NULL AUTO_INCREMENT,
  `good_id` mediumint(9) UNSIGNED NULL DEFAULT NULL COMMENT '关联商品id',
  `order_id` mediumint(9) UNSIGNED NULL DEFAULT NULL COMMENT '入库订单id',
  `num` mediumint(9) UNSIGNED NULL DEFAULT NULL COMMENT '入库数量',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单关联表' ROW_FORMAT = Compact;
...
INSERT INTO `w_order_list` VALUES (8, 1, 5, 2);
INSERT INTO `w_order_list` VALUES (9, 3, 5, 3);
INSERT INTO `w_order_list` VALUES (10, 1, 6, 2);
INSERT INTO `w_order_list` VALUES (11, 4, 6, 3);
INSERT INTO `w_order_list` VALUES (12, 4, 7, 2);
INSERT INTO `w_order_list` VALUES (13, 6, 7, 3);
...
CREATE TABLE `w_product`  (
  ...
  `nbsn` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `cjsn` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `category` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `storage` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `shelve` mediumint(9) NULL DEFAULT NULL,
  ...
  `add_time` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '产品' ROW_FORMAT = Compact;
...
INSERT INTO `w_product` VALUES (3, '5a4644bcb7ec1', '服装', '', '5a4644bcb7ec1', '服装', '华东仓库', 'B区', '箱', '苏州牧冬光电有限公司', '爱美克空气过滤器', NULL, '', 50.00, 20, 0, '', 1514554572);
INSERT INTO `w_product` VALUES (4, '5a470f4c59ebd', '荣耀V10', '', '5a470f4c59ebd', '手机', '华东仓库', 'B区', '个', '苏州牧冬光电有限公司', '爱美克空气过滤器', NULL, '', 1999.00, 4, 0, '', 1514606441);
...
CREATE TABLE `w_productup`  (
  `id` mediumint(9) UNSIGNED NOT NULL AUTO_INCREMENT,
  `gid` mediumint(9) NULL DEFAULT NULL,
  `storage` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `location` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `shelve` mediumint(9) NULL DEFAULT NULL,
  `shelve_list` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
INSERT INTO `w_role` VALUES (2, '仓库管理', '5,6,7,4', 0, '11111111', 1515743749);
...
CREATE TABLE `w_shelve`  (
  ...
  `status` tinyint(1) UNSIGNED NOT NULL COMMENT '0',
  `list` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `desc` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `add_time` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '货架管理' ROW_FORMAT = Compact;
...
CREATE TABLE `w_storage`  (
  `id` mediumint(9) UNSIGNED NOT NULL AUTO_INCREMENT,
  `sn` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '编号',
  ...
  UNIQUE INDEX `name`(`name`) USING BTREE,
  UNIQUE INDEX `sn`(`sn`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '仓库管理' ROW_FORMAT = Compact;
...
CREATE TABLE `w_supplier`  (
  ...
  UNIQUE INDEX `name`(`name`) USING BTREE,
  UNIQUE INDEX `sn`(`sn`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '供应商' ROW_FORMAT = Compact;
...
CREATE TABLE `w_user`  (
  ...
  `sn` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  ...
  `eamil` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '邮箱',
  `truename` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `status` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '状态 0:正常 1:禁用',
  `desc` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `add_time` int(11) UNSIGNED NULL DEFAULT NULL,
  `role` mediumint(10) UNSIGNED NULL DEFAULT NULL,
  `company` mediumint(10) UNSIGNED NULL DEFAULT NULL COMMENT '公司',
  PRIMARY KEY (`id`) USING BTREE,
...
INSERT INTO `w_user` VALUES (5, '22102902044099002', '2210290204409900', 'e10adc3949ba59abbe56e057f20f883e', NULL, NULL, 'dashen', 0, '新来的员工，多多照顾', 1667023533, 2, 1);
